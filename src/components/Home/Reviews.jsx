              ...
              <div className="w-[25%]">
                <div id="rocket" className=" md:w-[100px] mx-auto ">
                  <img
                    width={150}
                    height={100}
                    src={"https://www.sibinfotech.com/digital-marketing-services-in-india/rocket.png"}
                    alt="rocket"
                  />
                </div>
              </div>
              ...
              <div>
                <div className="w-[25px] md:w-[70px]">
                  <img
                    width={100}
                    height={100}
                    src={"https://www.sibinfotech.com/digital-marketing-services-in-india/left-quote.png"}
                    alt=""
                  />
                </div>
              </div>
