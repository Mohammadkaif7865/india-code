...
const SocialMedia = () => {
  return (
    <div className="py-12 lg:py-20 bg-white ">
      <div className="w-[90%] mx-auto flex max-lg:flex-col gap-8 lg:gap-12 ">
          ...
          <div className="lg:sticky lg:top-0 ">
            <div className="relative w-[100%] overflow-hidden min-h-[300px] md:min-h-[600px] ">
              <img
                ...
                height={600}
                quality={100}
                src={"https://www.sibinfotech.com/digital-marketing-services-in-indiahttps://www.sibinfotech.com/digital-marketing-services-in-mumbai/social-media-marketing.jpg"}
